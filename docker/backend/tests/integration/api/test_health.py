...
def _settings(tmp_path: Path, **overrides: object) -> Settings:
    defaults = {
        ...
        "app_env": "development",
        # These tests exercise the HTTP layer only — starting real
        # monitors (which ping the actual internet) here would make
        # them slow, flaky, and network-dependent for no reason.
